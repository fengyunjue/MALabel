...
/**
 ...
 @param userInfo 附加信息
 */
+ (NSMutableAttributedString *_Nonnull)attStringWithImage:(UIImage *_Nullable)image font:(UIFont *_Nullable)font imageHeight:(CGFloat)imageHeight spacing :(CGFloat)spacing spacingAddLeft:(BOOL)spacingAddLeft topSpacing:(CGFloat)topSpacing userInfo:(NSDictionary * _Nullable)userInfo;
/// 图片高度为font.pointSize
+ (NSMutableAttributedString *_Nonnull)attStringWithImage:(UIImage *_Nullable)image font:(UIFont *_Nullable)font spacing:(CGFloat)spacing spacingAddLeft:(BOOL)spacingAddLeft topSpacing:(CGFloat)topSpacing userInfo:(NSDictionary * _Nullable)userInfo;
/**
