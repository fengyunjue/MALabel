...
- (void)viewDidLoad {
    ...
    NSMutableAttributedString *attStr = [MAContentLabelHelp attributedString:@"您将同意《 巴拉巴拉小魔仙协议 》werwerwek 18743849283 ma772528138@qq.com www.baidu.com http://www.kf5.com w.c.c " labelHelpHandle:MALabelHelpHandleAll font:nil color:nil];
    ...
    NSAttributedString *imageString = [MAContentLabelHelp attStringWithImage:[UIImage imageNamed:@"123.jpg"] font:[UIFont systemFontOfSize:30] spacing:100 spacingAddLeft:NO topSpacing:0 userInfo:@{}];
      ...
      [MAContentLabelHelp addSuperLinkAttributeWithString:attStr userInfo:@{@"1231":@"1231231313"} linkTextTouchAttributes:@{NSBackgroundColorAttributeName:[UIColor purpleColor]} range:NSMakeRange(0, attStr.length)];
